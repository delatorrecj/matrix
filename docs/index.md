...
| Methods & Traceability (glass-box ledger) | [methods-matrix.md](methods-matrix.md) | 0.1 | **Locked** | 2026-06-25 | 2026-06-25 (CR-012 PR #37 — §4.2 kernel `_resolve_edges` gazetteer + deterministic-hash fallback documented + re-locked; prior: CR-010 §4/§4.3 synthesis BLUF + delimited bilingual) |
